...
exception Ran_tests
let suite = ref (Studenttests.provided_tests @ Gradedtests.graded_tests @ Studenttests.provided_tests @ Studenttests_others_official_old.provided_tests @ Studenttests_moodle_others.provided_tests)
